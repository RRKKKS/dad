...
async def anem_1(c, msg):
    ...
    animation_chars = [
        ...
        "😡",
        "😢",
        "__**[قناه تنصيب حسابات تيليثون - ✅]**__(t.me/S_EG_P)",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
@Client.on_message(filters.command(["cr", "سورس كرستين", "السورس"], ".") & filters.me)
async def gajjajay(client: Client, message: Message):
    ...
    await asyncio.sleep(0.5)
    await message.edit("cr بتعمل عظمه ")
    await asyncio.sleep(0.2)
    ...
    await message.edit("🔥🔥🔥")
    await asyncio.sleep(0.3)
    await message.edit("هلو هنا هتشوف الجمدان كلو cr بتعمل عظمه فوق اي حد 🔥🔥🔥")
